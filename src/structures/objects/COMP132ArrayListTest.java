...
public class COMP132ArrayListTest {
    protected COMP132List myList;

    @Before
    public void setUp() throws Exception {
        myList = new COMP132ArrayList();
    }
    ...
    public void testAddAndGet() {
        ...
        assertEquals("wrong 1th element", "Item1", myList.get(1));
        assertEquals("wrong 2th element", "Item2", myList.get(2));
